...
#include <vector>
#include "04_remove_duplicates.h"
...
TEST_F(RemoveDuplicatesTest, BasicTest) {
    assertRemoveDuplicates({1, 1, 1, 2, 2, 3}, {1, 1, 2, 2, 3}, 5);
}
...
TEST_F(RemoveDuplicatesTest, AllDuplicates) {
    assertRemoveDuplicates({2, 2, 2, 2}, {2, 2}, 2);
}

TEST_F(RemoveDuplicatesTest, MixedDuplicates) {
    assertRemoveDuplicates({0, 0, 1, 1, 1, 2, 2, 3, 3, 4}, {0, 0, 1, 1, 2, 2, 3, 3, 4}, 9);
}
...
TEST_F(RemoveDuplicatesTest, LargeInput) {
    ...
    assertRemoveDuplicates(nums, expected, 6);
}